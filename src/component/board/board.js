...
const checkLeft=(squares,index)=>{
    //check existed
    if(squares[index-1]&& squares[index-2]&& squares[index-3] && squares[index-4])
    {
        if(squares[index]===squares[index-1]&&squares[index-1]===squares[index-2]&& squares[index-2]===squares[index-3]
...
const checkTopLeft=(squares,index)=>{
    //check existed
    if(squares[index-(size+1)]&& squares[index-(size+1)*2]&& squares[index-(size+1)*3] && squares[index-(size+1)*4])
    {
        if(squares[index]===squares[index-(size+1)]&&squares[index-(size+1)]===squares[index-(size+1)*2]&& squares[index-(size+1)*2]===squares[index-(size+1)*3]
...
const checkTop=(squares,index)=>{
    //check existed
    if(squares[index-size]&& squares[index-size*2]&& squares[index-size*3] && squares[index-size*4])
    {
        if(squares[index]===squares[index-size]&&squares[index-size]===squares[index-size*2]&& squares[index-size*2]===squares[index-size*3]
